...
#include "farm_ng_proto/core/v1/io.pb.h"
...
typedef boost::signals2::signal<void(const farm_ng_proto::core::v1::Event&)>
    EventSignal;
...
class EventBus : public boost::asio::io_service::service {
 public:
  ...
  const std::map<std::string, farm_ng_proto::core::v1::Event>& GetState()
      const;

  const std::map<boost::asio::ip::udp::endpoint,
                 farm_ng_proto::core::v1::Announce>&
...
std::pair<farm_ng_proto::core::v1::Resource, boost::filesystem::path>
...
farm_ng_proto::core::v1::Resource ArchiveProtobufAsJsonResource(
...
template <typename ProtobufT>
farm_ng_proto::core::v1::Resource ArchiveProtobufAsBinaryResource(
    const std::string& prefix, const ProtobufT& message) {
...
template <typename T>
farm_ng_proto::core::v1::Event MakeEvent(
...
template <typename T>
farm_ng_proto::core::v1::Event MakeEvent(std::string name,
                                            const T& message) {
