...
import { TrackingCameraPoseFrame } from "@farm-ng/genproto-perception/farm_ng/perception/tracking_camera";
import { Plot } from "./Plot";
import { Vec3 } from "@farm-ng/genproto-perception/farm_ng/perception/geometry";
...
export const TrackingCameraPoseFrameVisualizer = {
  ...
  types: ["type.googleapis.com/farm_ng.perception.TrackingCameraPoseFrame"],
  options: [],
