...
import { CaptureCalibrationDatasetConfiguration } from "@farm-ng/genproto-perception/farm_ng/perception/capture_calibration_dataset";
...
export const CaptureCalibrationDatasetConfigurationVisualizer = {
  ...
  types: [
    "type.googleapis.com/farm_ng.perception.CaptureCalibrationDatasetConfiguration",
  ],
