...
from farm_ng.calibration.robot_hal_pb2 import CapturePoseRequest
from farm_ng.calibration.robot_hal_pb2 import CapturePoseResponse
from farm_ng.calibration.robot_hal_pb2_grpc import RobotHALServiceStub
...
def run():
    with grpc.insecure_channel('localhost:50051') as channel:
        stub = RobotHALServiceStub(channel)
